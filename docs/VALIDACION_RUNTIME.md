...
| SSL Certs | ✅ No aplica en dev | Solo aplica en producción (`docker-compose.prod.yml` → nginx). `certs/` no existe y no es necesario para desarrollo. Ver `docs/PRODUCCION_CHECKLIST.md` §1. |

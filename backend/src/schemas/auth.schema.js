...
// El login NO sube el minimo a 8: las cuentas creadas antes de F19(a) pueden tener
...
// D-06 — minimo 8 para las cuentas nuevas.
// `tenantId` ya no se acepta (D-07): el tenant sale del admin autenticado, no del
